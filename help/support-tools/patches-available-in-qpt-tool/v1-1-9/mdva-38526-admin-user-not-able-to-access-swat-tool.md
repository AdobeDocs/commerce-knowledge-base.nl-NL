...
Met de MDVA-38526-patch wordt het probleem opgelost waarbij de beheerder geen toegang heeft tot het SWAT-gereedschap. Deze pleister is beschikbaar wanneer de [Kwaliteitspatches (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.9 is geïnstalleerd. De patch-id is MDVA-38526. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.4.
...
Probeer te bereiken `../swat/key/index`
...
500 Fout wordt teweeggebracht met het volgende foutenlogboek: *Kan de serienummering van de waarde niet ongedaan maken. Fout: syntaxisfout*.
