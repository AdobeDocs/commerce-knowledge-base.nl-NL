...
De MDVA-38626-patch lost het probleem op waarbij de beheerder geen bestelling op de achtergrond kan plaatsen met de PayPal Payflow Pro-betalingsmethode. Deze pleister is beschikbaar wanneer de [Kwaliteitspatches (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.9 is geïnstalleerd. De patch-id is MDVA-38626. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
...
1. Ga naar **Klanten** > **Alle klanten** en maak een klantenaccount.
1. Klikken op **Volgorde maken**.
