...
De MDVA-43935-patch verhelpt het probleem waarbij het upselproduct tweemaal op de productpagina wordt weergegeven. Dit flard is beschikbaar wanneer het [ Hulpmiddel van de Patches van de Kwaliteit (QPT) ](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.13 geïnstalleerd is. De patch-id is MDVA-43935. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
