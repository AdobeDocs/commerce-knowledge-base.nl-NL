...
De MDVA-41136-patch lost het probleem op waarbij de vervaldatum van de `mage-cache-sessid` cookie wordt niet uitgebreid, waardoor de gegevens van de klant worden gewist. Deze pleister is beschikbaar wanneer de [Kwaliteitspatches (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.12 is geïnstalleerd. De patch-id is MDVA-41136. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
...
De vervaldatum van de `mage-cache-sessid` niet wordt uitgebreid, wat leidt tot het opschonen van klantgegevens.

<u>Stappen om te reproduceren</u>:

1. Ga in Commerce Admin naar **Winkels** > **Configuratie** > **Web** > **Standaardcookie-instellingen** > en set **Cookie Lifetime** tot 60.
...
De naam van de klant in de koptekst ontbreekt en de *Standaard welkomstbericht!* bericht wordt weergegeven.
