...
De MDVA-43348-patch verhelpt het probleem waarbij in het GraphQL-verzoek van Gift Card een fout wordt weergegeven als `gift_card_options` bevat &quot;uid&quot;. Deze pleister is beschikbaar wanneer de [Kwaliteitspatches (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.12 is geïnstalleerd. De patch-id is MDVA-43348. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
