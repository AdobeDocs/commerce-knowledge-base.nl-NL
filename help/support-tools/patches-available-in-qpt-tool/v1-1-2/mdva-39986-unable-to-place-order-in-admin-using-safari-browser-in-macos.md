...
De MDVA-39986-patch verhelpt het probleem dat gebruikers geen orders in de beheerder kunnen plaatsen via de Safari-browser op macOS. Dit flard is beschikbaar wanneer het [ Hulpmiddel van de Patches van de Kwaliteit (QPT) ](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.1.2 geïnstalleerd is. De patch-id is MDVA-39986. De kwestie is opgelost in Adobe Commerce 2.4.3.
