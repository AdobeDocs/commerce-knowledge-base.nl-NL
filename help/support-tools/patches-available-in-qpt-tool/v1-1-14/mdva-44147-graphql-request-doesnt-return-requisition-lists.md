...
1. Login als klant en voeg een product aan de [ Lijst van de Aanvraag ](https://experienceleague.adobe.com/nl/docs/commerce-admin/b2b/requisition-lists/requisition-lists) toe.
