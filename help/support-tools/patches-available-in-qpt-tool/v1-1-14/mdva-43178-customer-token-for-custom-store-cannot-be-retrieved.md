...
De patch MDVA-43178 verhelpt het probleem waarbij de token voor de klant van een aangepaste store niet kan worden opgehaald in GraphQL. Dit flard is beschikbaar wanneer het [ Hulpmiddel van de Patches van de Kwaliteit (QPT) ](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.14 geïnstalleerd is. De patch-id is MDVA-43178. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
