...
De ACSD-46192-patch verhelpt het probleem met de `async/bulk/V1/configurable-products/bySku/options` eindpunt. Deze pleister is beschikbaar wanneer de [Kwaliteitspatches (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.19 is geïnstalleerd. De patch-id is ACSD-46192. De kwestie is opgelost in Adobe Commerce 2.4.5.
...
Er treedt een fout op wanneer een verzoek van een POST wordt verzonden naar `async/bulk/V1/configurable-products/bySku/`.

<u>Stappen om te reproduceren</u>:

1. Een verzoek van een POST verzenden naar `async/bulk/V1/configurable-products/bySku/`.
