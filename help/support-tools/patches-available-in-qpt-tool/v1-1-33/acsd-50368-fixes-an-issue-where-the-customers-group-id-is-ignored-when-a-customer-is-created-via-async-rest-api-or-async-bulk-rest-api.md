...
De ACSD-50368-patch verhelpt het probleem waarbij de klanten group_id worden genegeerd wanneer een klant wordt gemaakt via de Async REST API of de Async Bulk REST API. Deze pleister is beschikbaar wanneer de [[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.33 is geïnstalleerd. De patch-id is ACSD-50368. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.7.
...
Customers group_id wordt genegeerd wanneer een klant wordt gemaakt via Async REST API of Async Bulk REST API.
...
1. Gebruik een Async Rest API-aanvraag om een klant te maken:
...
1. Een vergelijkbare reactie wordt gegeven:
...
1. Controleer de status van deze asynchrone aanvraag:
...
Group_id wordt correct geplaatst aan 2 voor de nieuwe klant.

<u>Werkelijke resultaten</u>:

Group_id wordt geplaatst aan gebrek 1 voor de nieuwe klant.
