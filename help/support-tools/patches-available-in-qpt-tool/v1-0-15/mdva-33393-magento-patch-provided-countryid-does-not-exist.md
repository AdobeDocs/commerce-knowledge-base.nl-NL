...
De flard MDVA-33393 lost de kwestie op waar het foutenbericht: *verstrekte countryId niet bestaat.* wordt weergegeven in het uitzonderingenlogboek.

Dit flard is beschikbaar wanneer het [ Hulpmiddel van de Patches van de Kwaliteit (QPT) ](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.15 geïnstalleerd is. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.3.
