...
* Ondersteuningsgereedschappen {#support-tools}
   ...
   * Reparaties beschikbaar in het gereedschap QPT {#patches}
      ...
      * v1.1.22 {#v1-1-22}
         ...
         * [ACSD-4744: [!UICONTROL Trying to access array offset on value of type bool] Fout bij het openen van bepaalde niet-bestaande categoriepaden voor bekende producten op PHP 7.4](/help/support-tools/patches-available-in-qpt-tool/v1-1-22/acsd-47444-trying-access-array-offset-value-type-bool-error.md)
      ...
      * v1.1.23 {#v1-1-23}
         ...
         * [ACSD-46519: product_count in [!UICONTROL categoryList] [!DNL GraphQL] query retourneert 0 voor ankercategorieën](/help/support-tools/patches-available-in-qpt-tool/v1-1-23/acsd-46519-product-count-categorylist-graphql-query-returns-zero-anchor-categories.md)
      ...
      * v1.1.24 {#v1-1-24}
         ...
         * [ACSD-47920: gastgebruikers kunnen opdrachten plaatsen via REST API, zelfs als [!UICONTROL Allow Guest Checkout] is uit](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47920-guest-order-allow-guest-checkout-off.md)
         ...
         * [ACSD-46770: bevestigingsbericht voor bestelling wordt verzonden, zelfs als [!UICONTROL Email order confirmation] is uitgeschakeld](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-46770-an-order-confirmation-email-is-sent-even-when-the-email-order-confirmation-is-unchecked.md)
         * [ACSD-4736: [!UICONTROL Something went wrong] foutmeldingen voor Adobe Commerce Admin zijn genegeerd](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47336-something-went-wrong-error-when-dismissing-notifications-adobe-commerce-admin.md)
      ...
      * v1.1.25 {#v1-1-25}
         ...
         * [ACSD-48313: [!UICONTROL configurable_variations] kolom niet geparseerd als kenmerkwaarde komma bevat](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48313-configurable-variations-column-not-parsed-attribute-value-contains-comma.md)
      ...
      * V1.1.27 {#v1-1-27}
         ...
         * [ACSD-48634: [!DNL JS] fouten bij [!DNL Google Analytics Content Experiments] enabled](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48634-js-errors-when-google-analytics-content-experiments-enabled.md)
      ...
      * v1.1.29 {#v1-1-29}
         ...
         * [ACSD-49835: [!UICONTROL Use Default Value] selectievakje is niet opgeslagen](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49835-use-default-value-chekbox-not-saved.md)
         ...
         * [ACSD-49502: Downloadbare koppeling wordt niet correct bijgewerkt na [!DNL staging] update](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49502-downloadable-link-not-updated-correctly.md)
         ...
         * [ACSD-50234: Onjuiste naam van klant in bevestigingsbericht voor bestellingen die zijn geplaatst met [!DNL PayPal]](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-50234-incorrect-customer-name-in-confirmation-email-for-orders-placed-with-paypal.md)
      ...
      * v1.1.32 {#v1-1-32}
         ...
         * [ACSD-49628: [!DNL Page Builder] Met CORS-fouten worden producten niet opgeslagen](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-49628-page-builder-cors-errors-prevent-product-save.md)
         ...
         * [ACSD-51379: wijzigingen in de tekstinhoud van een pagina via [!DNL Page Builder] niet worden opgeslagen](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51379-changes-made-to-page-text-content-via-page-builder-are-not-saved.md)
         ...
         * [ACSD-51294: Prijs, hoeveelheid, belasting, verzending, omzet verzonden als tekenreeks aan [!DNL Google Analytics] en GTM](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51294-price-quantity-tax-shipping-and-revenue-are-sent-as-string-to-google-analytics-and-gtm.md)
      ...
      * v1.1.3 {#v1-1-33}
         ...
         * [ACSD-51735: status van orderitem onjuist ingesteld op [!UICONTROL Ordered] wanneer de productvoorraad 0 is](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51735-order-item-status-incorrectly-set.md)
      ...
      * v1.1.35{#v1-1-35}
         ...
         * [ACSD-51149: gepland [!UICONTROL ImportExport] met ingeschakeld [!UICONTROL Catalog Permissions] validates indexers](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-51149-scheduled-importexport-enabled-catalog-permissions-invalidates-indexers.md)
         ...
         * [ACSD-52786: Catalogusregel [!UICONTROL SKU is] is van toepassing op alle producten die beginnen met SKU](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-52786-catalog-rule-sku-is-applies-to-all-products-starting-with-it.md)
         ...
         * [ACSD-52831: kan geen verhandelbare prijsbestellingen plaatsen wanneer [!DNL Google reCAPTCHA v3 Invisible] enabled](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-52831-cannot-place-negotiable-quote-orders.md)
      ...
      * v1.1.36{#v1-1-36}
         ...
         * [ACSD-53239: De indexeerder van de inventaris schrapt alle geheime voorgeheugens in [!UICONTROL Update on Schedule] mode](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-53239-inventory-indexer-cleans-all-caches.md)
         * [ACSD-5087: [!UICONTROL Use in Search Results Layered Navigation] ingesteld op Ja zonder de [!UICONTROL Use in Search] option](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-50887-product-attribute-use-in-search-results-layered-navigation-set-to-yes-without-use-in-search-option.md)
         * [ACSD-51846: Interne fout als [!DNL REST API] payload-niveaus worden niet gevalideerd](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-51846-internal-error-as-levels-of-rest-api-payload-are-not-validated.md)
      ...
      * v1.1.39 {#v1-1-39}
         ...
         * [ACSD-54660: Nieuwe invoerkenmerksortering naar sortering van klantorders in [!DNL GraphQL]](/help/support-tools/patches-available-in-qpt-tool/v1-1-39/acsd-54660-new-input-attribute-sort-to-sort-customer-orders-in-graphql.md)
      ...
      * v1.1.40 {#v1-1-40}
         ...
         * [ASCD-54040: [!UICONTROL Created] veld is leeg in de volgorde waarin de B2B-modules zijn ingeschakeld](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54040-created-field-is-blank-in-order-details-page.md)
         ...
         * [ACSD-55031: fout &#39;Type &quot;mix&quot; kan niet ongeldig zijn&#39; tijdens compilatie](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-55031-type-mixed-cannot-be-nullable-error-during-compilation.md)
         * [ACSD-54319: De prijs van het product is nul in de [!UICONTROL Products in Carts] verslag](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54319-product-price-shows-zero-in-product-in-cart-report.md)
         * [ACSD-54989: Bedrijfsbeheerder kan niet bestellen wanneer [!UICONTROL Enable Purchase Orders] ingesteld op Ja en [!UICONTROL Purchase Order] ingesteld op Nee](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54989-order-placement-restrictions-in-company-admin-settings.md)
      ...
      * v1.1.41 {#v1-1-41}
         ...
         * [ACSD-54376: Uitzondering in winkelwagentje wanneer het product wordt verwijderd [!UICONTROL shared catalog]](/help/support-tools/patches-available-in-qpt-tool/v1-1-41/acsd-54376-exception-shopping-cart-product-removed-from-shared-catalog.md)
      ...
      * v1.1.42 {#v1-1-42}
         ...
         * [ACSD-53568: [!UICONTROL Recently Viewed Product] gegevens zijn niet correct bijgewerkt in de winkelweergave](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-53658-fixes-the-issue-where-recently-viewed-product-data-is-not-updated-in-the-store-view.md)
         ...
         * [ACSD-5512: [!UICONTROL Submit Review] kan meerdere keren op de knop worden geklikt](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-55112-submit-review-button-can-be-clicked-multiple-times.md)
         ...
         * [ACSD-54890: de oorzaken van aggregaat_sales_report_bestsellers_data [!DNL MySQL] fouten](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54890-aggregate-sales-report-bestsellers-data-causes-mysql-errors.md)
      ...
      * v1.1.43 {#v1-1-43}
         ...
         * [ACSD-55305: Pop-up bevriest tijdens bewerking door bedrijfsgebruiker in [!UICONTROL My Account]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-55305-freeze-issue-in-company-user-edit-popup.md)
         ...
         * [ACSD-53636: de normale prijs wordt niet weergegeven op [!UICONTROL Product Listing] page](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53636-regular-price-is-not-displayed-on-product-listing-page.md)
         ...
         * [ACSD-53309: onvolledige belastingtoepassing voor aanpasbare opties en &quot;[!UICONTROL Regular Price]label](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53309-incomplete-tax-application-for-customizable-options.md)
      ...
      * v1.1.4 {#v1-1-44}
         ...
         * [ACSD-55352: maken [!UICONTROL Credit Memo] met bonuspunten](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55352-creating-credit-memos-with-reward-points.md)
         ...
         * [ACSD-56193: [!DNL Fastly/Varnish] cache niet gewist voor update van inhoudstaging](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56193-fastly-cache-not-cleared-for-content-staging-update.md)
      ...
      * v1.1.45 {#v1-1-45}
         ...
         * [ACSD-54965: [!UICONTROL Visual Merchandising] raster geeft de juiste voorraad niet weer](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-54965-visual-merchandising-grid-not-display-correct-stock.md)
         ...
         * [ASCD-56415: Prestaties van [!UICONTROL Partial Price Indexing] is vertraagd door DELETE query](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
      * v1.1.46 {#v1-1-46}
         * [Overzicht: [!DNL Quality Patches Tool] (QPT) v1.1.46](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/overview.md)
         * [ACSD-46767: [!UICONTROL Category] paginakaarten ongeldig maken wanneer het voorraadaantal verandert](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-46767-category-page-caches-invalidate-when-the-stock-quantity-changes.md)
         * [ACSD-54656: onzichtbaar [!DNL reCAPTCHA] mislukt tijdens uitchecken, wat plaatsing van bestelling verhindert](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-54656-invisible-recaptcha-fails-during-checkout-preventing-order-placement.md)
         ...
         * [ACSD-55100: [!DNL GraphQL] retourneert geen producten van meer dan 10 k in zoekresultaten](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-55100-graphql-does-not-return-products-beyond-10k-in-the-search-results.md)
      ...
      * v1.1.48 {#v1-1-48}
         ...
         * [ACSD-57315: Nieuwe transactie wordt gemaakt in [!DNL PayPal Payflow Pro] elke keer dat op de knop Ophalen wordt geklikt](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-57315-new-transaction-created-in-paypal-payflow-pro-each-time-the-fetch-button-is-clicked.md)
         * [ACSD-56635: Geïmporteerde klanten worden gedupliceerd wanneer het delen van een account is ingesteld op [!DNL Global]](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-56635-imported-customers-are-duplicated-with-the-same-email-address.md)
...
* Problemen oplossen {#troubleshooting}
   ...
   * Database {#database}
      ...
      * [Numerieke waarde Adobe Commerce-database valt buiten het bereik. [!DNL INT] tot [!DNL BIGINT]](/help/troubleshooting/database/int-biginit-schema-update-request.md)
   ...
   * Betalingen {#payments}
      * [Oplossen van problemen bij het maken van een bestelpagina in [!UICONTROL CSP] beperkte modus](/help/troubleshooting/payments/admin-create-order-page-in-csp-restricted-mode.md)
      * [Afhandelingspagina van storefont oplossen in [!UICONTROL CSP] beperkte modus](/help/troubleshooting/payments/storefront-checkout-page-in-csp-restricted-mode.md)
   ...
   * Installatie en upgrade {#installation-and-upgrade}
      ...
      * [[!DNL B2B] 1.4.0 de installatie ontbreekt op Adobe Commerce 2.4.6-p1 op gebouw](/help/troubleshooting/installation-and-upgrade/b2b-1-4-0-installation-fails-on-adobe-commerce-2-4-6-p1-on-premises.md)
   ...
   * Overige {#miscellaneous}
      * [Hoe controleert u waarom? [!DNL cron] was uitgeschakeld](/help/troubleshooting/miscellaneous/how-to-check-why-cron-was-disabled.md)
      * [Fout [!DNL opensearch] zoekmachine bestaat niet. Terugvallen op [!DNL livesearch].](/help/troubleshooting/miscellaneous/error-opensearch-search-engine-doesnt-exist-falling-back-to-livesearch.md)
      ...
      * [Redis unserialization error setup:static-content:inzetten](/help/troubleshooting/miscellaneous/redis-unserialize-error-setup-static-content-deploy.md)
...
* Hoe kan ik {#how-to}
   ...
   * [Controlelijst voor het instellen van een nieuwe [!DNL domain]](/help/how-to/general/checklist-for-setting-up-a-new-domain.md)
