...
1. De steun van Adobe Commerce van het contact [&#x200B; &#x200B;](https://experienceleague.adobe.com/nl/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) om zelf-geleid [!DNL crons] toegelaten te hebben.
...
* [&#x200B; de banen van de opstelling  [!DNL cron]  in onze ontwikkelaarsdocumentatie](https://experienceleague.adobe.com/nl/docs/commerce-operations/configuration-guide/cli/configure-cron-jobs)
