...
U kunt [&#x200B; een kaartje van de Steun van Adobe Commerce &#x200B;](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide) voorleggen om een speciale steun te verzoeken of van een specifieke steun te herstellen die de datum, de tijd, en de tijdzone in het kaartje verstrekt. Zodra het team van de Infrastructuur de momentopname heeft verstrekt, om timestamp te bepalen toen het oorspronkelijk werd genomen, stel het volgende bevel van de plaats in werking waar de momentopname is geplaatst:
...
* Het bedrag is 7 dagen beschikbaar en de retentieperiode kan niet worden verlengd. Als u een momentopname na deze tijd moet bewaren, moet u het aan een verschillende omslag of een externe server binnen dat tijdsbestek kopiëren
...
U kunt [&#x200B; een kaartje van de Steun van Adobe Commerce &#x200B;](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide) voorleggen om een speciale steun te verzoeken of van een specifieke steun te herstellen die de datum, de tijd, en de tijdzone in het kaartje verstrekt. De steun produceert geen handmomentopnamen op bestelling.
...
* Een handmatig geactiveerde momentopname wordt 7 dagen opgeslagen. Als u een momentopname na de bewaarperiode moet bewaren, kopieer het aan een verschillende omslag of een externe server binnen dat tijdskader. Om de momentopname op een recentere datum te herstellen, volg het zelfde proces dat in [&#x200B; wordt beschreven de gegevensbestandstortplaats van de server &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/how-to/restore-a-db-snapshot-from-staging-or-production#meth3) direct invoeren.
...
* Een manueel teweeggebrachte momentopname wordt opgeslagen voor **7 dagen**. Als u een momentopname na de bewaarperiode moet bewaren, kopieer het aan een verschillende omslag of een externe server binnen dat tijdskader. Om de momentopname op een recentere datum te herstellen, volg het zelfde proces dat in [&#x200B; wordt beschreven de gegevensbestandstortplaats van de server &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/how-to/restore-a-db-snapshot-from-staging-or-production#meth3) direct invoeren.
