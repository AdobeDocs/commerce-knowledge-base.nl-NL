...
description: '[Admin-gebruikers](https://experienceleague.adobe.com/nl/docs/commerce-business-intelligence/mbi/administrator/user-mgmt/user-management) hebben de mogelijkheid om bepaalde berekende kolommen te maken en te bewerken in Data Warehouse Manager. Deze berekende kolommen geven u de capaciteit aan opstelling het rapport u zoekt om zeer belangrijke bedrijfsvragen te beantwoorden.'
...
[&#x200B; Admin gebruikers &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-business-intelligence/mbi/administrator/user-mgmt/user-management) hebben de capaciteit om bepaalde berekende kolommen in de Manager van Data Warehouse tot stand te brengen en uit te geven. Deze berekende kolommen geven u de capaciteit aan opstelling het rapport u zoekt om zeer belangrijke bedrijfsvragen te beantwoorden.

Raadpleeg de volgende artikelen in onze gebruikershandleiding voor de lijst met berekende kolommen die u kunt maken in Data Warehouse Manager en voor richtlijnen om ervoor te zorgen dat u de kolommen correct instelt:
...
Als u hulp met het creëren van een regelmatige berekende kolom nodig hebt of een Geavanceerde Berekende Kolom wilt creëren of uitgeven, [&#x200B; bereik uit aan ons team &#x200B;](https://experienceleague.adobe.com/nl/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) en omvat het volgende:
